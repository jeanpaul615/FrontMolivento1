...
export const submitContrato = async (Nombre_contrato, Nombre_material, Nombre_tecnico, Cantidad, onClose) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/contrato/add-contratos`, {
      Nombre_contrato,
      Nombre_tecnico,
      Nombre_material,
      Cantidad,
    ...
    const response2 = await axios.put(`${API_BASE_URL}/stocktechnique/update-cantidad-stocktechnique`, {
      Nombre_material,
      Nombre_tecnico,
      Cantidad,
    });
